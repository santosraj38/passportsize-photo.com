...
@section('head')
  <title>Create Auto|ID Size Photo For Printing Instantly</title>
  ...
  <meta property="og:title"  content="Printable Auto|ID Size Photo Instantly 100% Free And Geneuine">
  <meta property="og:type"  content="website">
  <meta property="og:url"  content="{{route('autoprint')}}">
  ...
  <div class="ui stackable grid">
    <div class="eight wide column">
      <div class="ui segment">
        <div class="ui header">
          Convert To Auto Size For Printing
        </div>
        <div class="ui divider">

        </div>
        {!! Form::open(['method' => 'POST', 'route' => 'autoprint', 'class' => 'ui tiny form','files'=>'true','id'=>'resizeform']) !!}
          ...
          @if (session()->has('image')==false)
            <div class="ui field">
              ...
              <div id="viewlogo">
                  ...
                  {!! Form::submit("Auto Size For Printing", ['class' => 'ui fluid positive button','id'=>'submitresize']) !!}
            @else
              <div class="ui field">
                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                ...
                <div id="viewlogo">
                  <img src="{{asset('images/'.session('image'))}}" width="200px" height="200px" alt="">
                    ...
                    {!! Form::submit("Use Image Auto Size For Printing", ['class' => 'ui fluid positive button','id'=>'submitresize']) !!}
          @endif
    ...
    <div class="eight wide column">
      ...
      <div class="ui red header">
        Create Auto|ID Size Photo Ready To Print
      </div>
      <div class="ui bulleted list">
        <div class="item">Choose a photo</div>
        <div class="item">Upload, done</div>
      ...
      <div class="ui bulleted list">
        ...
        <div class="item">Passport Image Size 1.208 inch * 1.375 inch with 6px as border|clearence </div>
